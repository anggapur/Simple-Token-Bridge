...
const func: DeployFunction = async function ({
  ...
  if (network.live && !network.tags.mumbai) {
    console.warn(
...
func.tags = ['CHILD']; // This sets up a tag so you can execute the script on its own (and its dependencies).
